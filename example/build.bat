...
set PKG_TITLE="OrbisTTY Example"
set PKG_VERSION="1.00"
set PKG_ASSETS="assets"
set PKG_TITLE_ID="OTTY01010"
set PKG_CONTENT_ID="IV0000-OTTY01010_00-ORBISTTY0EXAMPLE"

Rem Libraries to link in
set libraries=-lc -lkernel -lc++ -lSceVideoOut -lSceFreeType -lSceSysmodule
